...
#    path = raw_input('Please input app path\nFor example:/Users/LJP_1/Library/Developer/Xcode/DerivedData/***/Build/Products/Debug-iphoneos/***.app\n').strip()
#    path = verified_app_path(path)

    path = '/Users/LJP_1/Library/Developer/Xcode/DerivedData/huhuAudio-gfarogipbvtxcbfqkkytbajgtvqx/Build/Products/Debug-iphoneos/huhuAudio.app'
